...
# Generation Time: 2015-03-24 19:22:05 +0000
# ************************************************************
...
VALUES
	...
	(19,19,'daffys-bday','Daffy\'s','','Daffy\'s Birthday Blowout',NULL,'Our team was challenged by Devito/Verdi to create a Facebook app for Daffy\'s 50th birthday.\n\nIn response, we created a virtual birthday cake, where Facebook fans could blow out the candle using their computer\'s built-in microphone. The application was optimized to account for varying sound sensitivity issues as well as different mic arrangements for MACs and PC computers.\n\nThe results? 4,350+ active users used the Facebook app featured on dailyness.com.</p>\n\n<p class=\"credits\">\n<span class=\"description-label\">Client:</span>Daffy\'s\n<span class=\"description-label\">Credits:</span>DeVito/Verdi, Click 3X and Clickfire Media\n<span class=\"description-label\">Platforms:</span>Social Media - Facebook','daffys','daffys'),
