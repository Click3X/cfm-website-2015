...
<div class="project-detail">
	<div class="project-heading">
		<div class="project-heading-inner">
			...
			<?php if( count($assets) > 1): ?><div class="video-anchor-link"><a href="#<?php echo $data->slug; ?>-video"><span class="arrow"></span><span class="label"><?php echo !empty($assets[1]->title) ? $assets[1]->title : "Watch Case Study"; ?></span></a></div><?php endif; ?>
		</div>
	</div>
