...
<div id="<?php echo rand(); ?>-video" class="cfm-videoplayer project-module-video" data-video="http://media.click3x.com/video/<?php echo $module->media[0]->filename; ?>" data-poster="http://media.click3x.com/images/cfm/modules/banner-video/<?php echo $module->media[0]->filename; ?>.jpg">
